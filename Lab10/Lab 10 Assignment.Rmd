...
For panther 147, its habitat is 55% wet forest and only 12% dry forest. The dry forest is much scarcer on the landscape than wet forest, therefore, it is not surprising that its percentage is low and it could be the amount that is simply available to the panther. Wet forest, however, looks a bit more selected for by the panthers and may not be indicative of the actual amount present across the entire study area. 
...
I would say that it prefers wet forest more. The proportion of wet forest is much higher than dry forest at all homerange percentages. Additionally, dry forest appears to drop off more readily than wet forest. Wet forest stays roughly constant until a high homerange percentage, indicating that panthers might be utilizing wet forest a majority of the time. 
